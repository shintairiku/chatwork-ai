...
```
assignee_name,assignee_contact,customer_group_id,customer_name,last_message_at,monthly_message_count
```

既存シートとの互換のため、固定キー行がない場合は従来の日本語ヘッダーでも読み取れます。
